...
public abstract class CustomBarrelBlockEntity extends LootableContainerBlockEntity {

    protected DefaultedList<ItemStack> inventory;
    protected int viewerCount;

    public CustomBarrelBlockEntity(BlockEntityType<?> blockEntityType) {
    ...
    public void setOpen(BlockState state, boolean open) {
        this.world.setBlockState(this.getPos(), state.with(CustomBarrelBlock.OPEN, open), 3);
    }

    public void playSound(BlockState blockState, SoundEvent soundEvent) {
        Vec3i vec3i = blockState.get(CustomBarrelBlock.FACING).getVector();
