...
import wraith.basedcooking.block.CrateBlock;
...
public class BlockRegistry {
    ...
    private static final HashMap<String, Block> BLOCKS = new HashMap<String, Block>() {{
        ...
        put("crate", new CrateBlock(FabricBlockSettings.of(Material.WOOD, MaterialColor.BROWN).sounds(BlockSoundGroup.WOOD).strength(2.5F)));
